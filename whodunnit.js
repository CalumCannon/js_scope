...
//Scarlet, Plum, Mustard: suspectOne is changed within the declareAllSuspects and return to suspects
...
const verdict = declareMurderer();
console.log(verdict);
//`The murderer is Prof Plum: use of let means it creates a new murderer variable scoped to the function block only
